  ...
  <!-- <div class="PackView is-marginless is-clipped">
    ...
    <section class="section1">
          <div class="sectionContainer">
              <div class="logo">
                  <img alt="" width="350" srcset="../../static/pictures/logo.svg"/>
              </div>
              <div class="titleNav">
                  <div>
                      <p class="title">基於區塊鏈的稀有遊戲道具、資產交易和內容分發平台</p>
                      <p class="subtitle">便捷上鍊，開放交易，去中心化分發</p>
                  </div>
                  <br/>
                  <div class="btndiv">
                    <router-link class="gotoGame button is-medium"
                                  :to="{ name: 'Game' }">前往社区</router-link>
                  </div>
                  <div class="btndiv">
                    <router-link class="gotoShop button is-medium"
                                  :to="{ name: 'PreSale' }">留下邮箱</router-link>
                  </div>
                  <div class="btndiv">
      ...
      <div class="section3Container">
        ...
        <div class="columns section3container">
          ...
          <a class="section2title">独创的区块链抽卡玩法</a>
            ...
            <div class="btndiv">
              <router-link class="gotoGetCard button is-medium" :to="{ name: 'PreSale' }">前往抽卡</router-link>
            </div>
          </div>
        </div>
      </div>
...
*/
.section1 {
  background-image: url("../../static/pictures/index_overview.png");
  background-size: 100%;
...
.gotoGame {
  background-image: linear-gradient(-180deg,rgb(126, 178, 206),rgb(163, 163, 255));
  background-size: cover;
  height: 48px;
  width: 130px;
...
.gotoShop {
  background-image: linear-gradient(-180deg,rgb(0, 97, 150),rgb(29, 29, 185));
  background-size: cover;
  height: 48px;
  width: 130px;
  background-color: transparent;
